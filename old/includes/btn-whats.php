...
.wa__btn_popup .wa__btn_popup_icon:before {
    ...
    left: 0;
    top: 0;
    background: transparent url('/assets/img/whats.png') center center no-repeat;
...
.wa__btn_popup .wa__btn_popup_icon:after {
    ...
    left: 0;
    top: 0;
    background: transparent url('/assets/img/close.png') center center no-repeat;
    background-size: 40px auto;
    -webkit-background-size: 40px auto;
    -moz-background-size: 40px auto;
    transition: 0.4s ease all;
...
<div class="wa__popup_chat_box">
    <div class="wa__popup_heading">
        ...
        <div class="wa__popup_intro">Un asesor lo podrá ayudar en <strong>WhatsApp</strong>
    ...
    <div class="wa__popup_content wa__popup_content_left">
        ...
        <div class="wa__popup_content_list">
            <div class="wa__popup_content_item ">
                <a target="_blank" href="https://wa.me/+526241190222?text=Hola,%20me%20gustaría%20más%20información"
                    class="wa__stt wa__stt_online">
                    <div class="wa__popup_avatar">
                        <div class="wa__cs_img_wrap">
                            <img style="width: 3rem;" src="/assets/img/chat.jpg" alt="">
                        </div>
                    </div>

                    <div class="wa__popup_txt">
                        <div class="wa__member_name">XM Design</div>
                        <!-- /.wa__member_name -->
                        <div class="wa__member_duty">Diseño de interiores</div>
                        <!-- /.wa__member_duty -->
                    </div>
                    <!-- /.wa__popup_txt -->
                </a>
