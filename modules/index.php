        ...
        <div class="arck-main-slider-item position-relative">
            ...
            <div class="container">
                <div class="arck-slider-main-text headline position-relative">
                    ...
                    <h1>
                        Creando espacios elegantes y únicos <br>
                    </h1>
                    <div class="arck-btn">
    ...
    <div class="container">
        <div class="arck-service-content">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 no-padding wow fadeInUp" data-wow-delay="200ms"
                ...
                <div class="col-lg-4 col-md-6 no-padding wow fadeInUp" data-wow-delay="400ms"
                    data-wow-duration="1500ms">
                ...
                <div class="col-lg-4 col-md-6 no-padding wow fadeInUp" data-wow-delay="600ms"
                    data-wow-duration="1500ms">
                    <div class="arck-service-item text-center position-relative">
        ...
        <div class="arck-project-top-content d-flex justify-content-between align-items-center">
            ...
            <div hidden class="arck-project-filter-btn ul-li text-center">
                <ul class="filter clearfix">
                    ...
                    <li data-filter="three" class="three">3D Design</li>
                    <li data-filter="foure" class="foure">Building</li>
                    <li data-filter="five" class="five">House & Exterior</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="arck-project-item position-relative two">
                ...
                <div class="inner-text">
                    <div class="project-title-desc headline pera-content">
                        <span class="text-uppercase item-category"><a href="project.html">Architecture</a></span>
                        <h3><a href="project-single.html">Mixitu Duplex Home</a></h3>
                        <p>Information architecture helps organize content overall so it’s easy to find and use. Imagine
                            a storeroom filled to the brim with things these things are all related to sports.</p>
                    </div>
                </div>
    ...
    <div class="arck-video-play-wrap position-absolute" data-background="/assets/img/bg/v-bg.jpg">
        ...
        <div class="arck-video-play-btn">
            <a class="d-flex align-items-center video_box justify-content-center"
                href="https://www.youtube.com/watch?v=OB_Ok4dZ-dg"><i class="fas fa-play"></i></a>
        </div>
